...
public class LoadProductController extends HttpServlet {
    ...
    private final static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(LoadProductAdminController.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(LoadProductController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
